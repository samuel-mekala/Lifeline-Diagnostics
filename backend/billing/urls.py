...
urlpatterns = [
    ...
    path("<str:invoice_id>/download/", DownloadInvoiceAPIView.as_view(), name="download-invoice"),
    path("verify/<uuid:token>/", VerifyInvoiceAPIView.as_view(), name="verify-invoice"),
    path(
        "create/<str:visit_id>/",
