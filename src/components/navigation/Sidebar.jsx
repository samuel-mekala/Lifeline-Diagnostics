    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-3 space-y-1">
          <div className={`px-2.5 py-1.5 text-[10px] font-extrabold uppercase tracking-wider text-slate-400 ${isCollapsed ? 'text-center' : ''}`}>
            {isCollapsed ? '•••' : role === 'PATIENT' ? 'Patient Navigation' : 'Operations Workflow'}
          </div>
